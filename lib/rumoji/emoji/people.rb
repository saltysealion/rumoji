...
module Rumoji
  class Emoji
    PEOPLE = Set[
      ...
      self.new("\u{1F468}\u{200D}\u{1F468}\u{200D}\u{1F467}\u{200D}\u{1F466}", [:family_man_man_girl_boy], [], "Family (Man, Man, Girl, Boy)"),
      self.new("\u{1F468}\u{200D}\u{1F468}\u{200D}\u{1F467}", [:family_man_man_girl], [], "Family (Man, Man, Girl)"),
      self.new("\u{1F468}\u{200D}\u{1F468}\u{200D}\u{1F466}", [:family_man_man_boy], [], "Family (Man, Man, Boy)"),
      self.new("\u{1F469}\u{200D}\u{1F469}\u{200D}\u{1F467}\u{200D}\u{1F467}", [:family_man_woman_girl_girl], [], "Family (Woman, Woman, Girl, Girl)"),
      self.new("\u{1F469}\u{200D}\u{1F469}\u{200D}\u{1F466}\u{200D}\u{1F466}", [:family_man_woman_boy_boy], [], "Family (Woman, Woman, Boy, Boy)"),
      self.new("\u{1F469}\u{200D}\u{1F469}\u{200D}\u{1F467}\u{200D}\u{1F466}", [:family_man_woman_girl_boy], [], "Family (Woman, Woman, Girl, Boy)"),
      self.new("\u{1F469}\u{200D}\u{1F469}\u{200D}\u{1F467}", [:family_woman_woman_girl], [], "Family (Woman, Woman, Girl)"),
      self.new("\u{1F469}\u{200D}\u{1F469}\u{200D}\u{1F466}", [:family_woman_woman_boy], [], "Family (Woman, Woman, Boy)"),
      self.new("\u{1F468}\u{200D}\u{1F469}\u{200D}\u{1F467}\u{200D}\u{1F467}", [:family_man_woman_girl_girl], [], "Family (Man, Woman, Girl, Girl)"),
      self.new("\u{1F468}\u{200D}\u{1F469}\u{200D}\u{1F466}\u{200D}\u{1F466}", [:family_man_woman_boy_boy], [], "Family (Man, Woman, Girl, Boy)"),
      self.new("\u{1F468}\u{200D}\u{1F469}\u{200D}\u{1F467}\u{200D}\u{1F466}", [:family_man_woman_girl_boy], [], "Family (Man, Woman, Boy, Boy)"),
      ...
      self.new("\u{1F61C}", [:stuck_out_tongue_winking_eye, :wink2], [:";p", :";-p", :";b", :";-b"], "FACE WITH STUCK OUT TONGUE AND WINKING EYE"), # "kidding, not serious"
      ...
      self.new("\u{1F61B}", [:stuck_out_tongue], [:":p", :":-p", :":b", :":-b"], "FACE WITH STUCK-OUT TONGUE"),
      ...
      self.new("\u{1F627}", [:anguished], [:"D:"], "ANGUISHED FACE"),
      self.new("\u{1F62E}", [:open_mouth], [:":o", :":-o"], "FACE WITH OPEN MOUTH"),
      ...
      self.new("\u{1F60E}", [:sunglasses], [:"8)"], "SMILING FACE WITH SUNGLASSES"),
      ...
      self.new("\u{1F494}", [:broken_heart], [:"</3"]),
